...
const Header = () => {
  return (
    <section className="w-full bg-slate-100 lg:h-20 h-fit flex lg:flex-col justify-between items-center p-4 rounded-xl lg:gap-2 gap-4">
      <div>
        ...
        >
          ...
          <div className="flex flex-col justify-center items-start">
            <div className="flex justify-center items-center -mb-1 gap-2">
              <h1 className="text-lg font-semibold">Hi, Jack</h1>
              <IoIosArrowDown />
            </div>
            <p>Admin</p>
          </div>
